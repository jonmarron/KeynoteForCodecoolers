...
const HeadlineBulletsForm = ({slides, setSlides, index}) => {
  ...
  return (
    <div className="slideform" id={index}>
      ...
      <div className="slide-content two-columns-form">
        ...
        <input type='text' name="" cols="30" rows="10" placeholder='Add your copy text here ...' value={copyText} onChange={e => {setCopyText(e.target.value)}}/>
      </div>
      {created?(
        <>
...
export default HeadlineBulletsForm